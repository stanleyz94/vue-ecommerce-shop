    ...
    >
      <div class="space-y-5">
        ...
        <BaseCheckbox
          :class="{
            'opacity-50':
              wardrobeAmount('Miękkie domykanie') == 0 ? true : false,
          }"
        ...
        <BaseCheckbox
          :class="{
            'opacity-50':
              wardrobeAmount('Szuflady szklane') == 0 ? true : false,
          }"
        ...
        <BaseCheckbox
          :class="{
            'opacity-50':
              wardrobeAmount('Regulowane stopki') == 0 ? true : false,
          }"
        ...
        <BaseCheckbox
          :class="{
            'opacity-50':
              wardrobeAmount('Regulowane drązki na ubrania') == 0
                ? true
                : false,
          }"
        ...
        <BaseCheckbox
          :class="{
            'opacity-50':
              wardrobeAmount('Regulowane nóżki') == 0 ? true : false,
          }"
